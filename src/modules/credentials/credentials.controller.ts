...
export class CredentialsController {
  ...
  @Get()
  @Roles(Role.USER)
  public getCredentials(@User() user: UserEntity) {
  ...
  public async revoke(@Param('id') id: string, @User() user: UserEntity) {
  ...
  @Roles(Role.USER)
  @HttpCode(HttpStatus.NO_CONTENT)
  public async authorize(@Body() data: AuthorizeDto, @User() user: UserEntity) {
